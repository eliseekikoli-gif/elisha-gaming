...
class AppState extends ChangeNotifier {
  ...
  // Historique vidéo (point de reprise)
  ...
  void updateProfile({required String name, required String targetGoal, required int dailyGoal, required int avatarIdx}) {
    profile.name = name;
    profile.targetGoal = targetGoal;
    profile.dailyGoalMinutes = dailyGoal;
    profile.avatarIndex = avatarIdx;
    notifyListeners();
  }
            ...
            return Padding(
              ...
              child: Column(
                ...
                children: [
                        ...
                        onPressed: () async {
                          ...
                          if (pickedTime != null) {
                            final newRem = ReminderItem(
                              ...
                              label: 'Pratique de l\'anglais En-Speaking',
                            );
                  ...
                  const SizedBox(height: 12),
                  const Text('Configurez vos alertes pour maintenir votre assiduité :', style: TextStyle(fontSize: 12, color: Colors.white60)),
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(content: Text('Rappels d\'apprentissage mis à jour avec succès !')),
                        );
                      },
                      child: const Text('FERMER ET APPLIQUER', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
                    ),
                  ),
                ],
              ),
...
class _LessonsScreenState extends State<LessonsScreen> {
  ...
  final List<Map<String, dynamic>> lessonCatalog = [
    {
      'id': 'lesson_intro',
      'title': 'Salutations et Présentations Fluides',
      'level': 'Débutant',
      ...
      'vocab': [
        ...
        {'en': 'I specialize in technology', 'fr': 'Je me spécialise dans la technologie'},
      ],
      'grammar': 'Utilisez le présent simple pour parler de vos habitudes et de votre profession ("I work as a software engineer").',
      'exercise': 'Comment dit-on "Ravi de vous rencontrer" de manière professionnelle ?\n-> "Pleased to meet you".',
    },
    {
      'id': 'lesson_pres_perf',
      'title': 'Maîtriser le Present Perfect',
      'category': 'Grammaire',
      'xp': 50,
      'duration': '12 min',
      'vocab': [
        {'en': 'Already', 'fr': 'Déjà (dans une phrase affirmative)'},
        {'en': 'Yet', 'fr': 'Encore / Déjà (négations et questions)'},
        {'en': 'Achieve goals', 'fr': 'Atteindre ses objectifs'},
      ],
      'grammar': 'Structure : HAVE / HAS + Participe Passé. Règle : sert à exprimer une expérience dont la date exacte n\'est pas précisée.',
      'exercise': 'Complétez : "I have ____ (finish) my report." -> "finished".',
    },
    {
      'id': 'lesson_business',
      'title': 'Anglais Professionnel : Réunions & Décisions',
      'category': 'Business',
      'xp': 60,
      'duration': '15 min',
      'vocab': [
        {'en': 'To streamline', 'fr': 'Optimiser et simplifier'},
        {'en': 'To reach consensus', 'fr': 'Parvenir à un accord commun'},
        {'en': 'Action items', 'fr': 'Tâches à réaliser'},
      ],
      'grammar': 'Utilisation des verbes modaux de politesse : "Could we schedule a follow-up meeting?"',
      'exercise': 'Que signifie "Action items" ? -> La liste des tâches convenues.',
    },
    {
      'id': 'lesson_idioms',
      ...
      'grammar': 'Les expressions idiomatiques ne se traduisent pas mot à mot. Mémorisez leur équivalent direct en situation.',
      'exercise': 'Traduisez : "That test was a piece of cake!" -> "Ce test était un jeu d\'enfant !"',
    },
  ];
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            child: Text(
                              isDone ? 'LEÇON TERMINÉE ✓' : 'TERMINER LA LEÇON (+${lesson['xp']} XP)',
...
class _SpeakingAndAudioScreenState extends State<SpeakingAndAudioScreen> {
  ...
  int voiceScore = 0;
  String voiceFeedback = "Écoutez la phrase, puis appuyez sur le micro pour la répéter à haute voix.";
  Timer? waveTimer;
  double waveScale = 1.0;

  final List<Map<String, String>> audioLessons = [
    {
      'title': 'Prononciation : Les opportunités mondiales',
    ...
    {
      'title': 'Situation : Demander une précision en réunion',
    ...
    {
      'title': 'Expression : Exprimer une totale conviction',
  ...
  void startVoiceEvaluation() {
    ...
    Future.delayed(const Duration(seconds: 3), () {
      if (!mounted) return;
      waveTimer?.cancel();
      final score = 92 + Random().nextInt(8); // Score entre 92% et 99%
      setState(() {
        isVoiceRecording = false;
        isVoiceAnalyzed = true;
        voiceScore = score;
        voiceFeedback = "Excellente élocution ! Intonation fluide et accent maîtrisé (Score : $score%).";
      });
          ...
          Center(
            child: Column(
              children: [
                ...
                const SizedBox(height: 10),
                Text(isVoiceRecording ? 'Analyse du rythme vocal...' : 'Appuyez pour parler à voix haute', style: const TextStyle(fontSize: 13, color: Colors.white60)),
              ],
            ),
          ),
        ],
  ...
  final List<Map<String, dynamic>> videoLessons = [
    {
      ...
      'duration': '10:45',
      'subtitles': 'When introducing yourself, always maintain eye contact and state your value proposition clearly.',
    },
    {
      'id': 'vid_2',
          ...
          ...List.generate(videoLessons.length, (idx) {
            ...
            return Container(
              ...
              child: ListTile(
                ...
                subtitle: Text('Reprendre à ${(AppState.instance.videoProgressMap[v['id']] ?? 0.0 * 100).toInt()}% • ${v['duration']}', style: const TextStyle(fontSize: 12, color: Colors.white60)),
  ...
  final Map<String, List<Map<String, dynamic>>> quizBank = {
    'Débutant': [
      ...
      },
      {
        ...
        'options': ['Une ligne rouge de sécurité', 'Une date limite impérative', 'Un coup de téléphone', 'Une fin de réunion'],
        'answer': 1,
        'expl': 'Deadline désigne la date ou l\'heure limite pour rendre un travail.',
      },
    ],
    'Intermédiaire': [
      {
        ...
        'answer': 2,
        'expl': 'On utilise le Present Perfect pour relater une expérience sans date révolue.',
      },
      {
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              Text('Vous remportez +${currentScore * 20} points d\'XP !', style: const TextStyle(fontSize: 14, color: Colors.white70)),
        ...
        builder: (context, setDialogState) => AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                state.updateProfile(name: nameCtrl.text.trim(), targetGoal: goalCtrl.text.trim(), dailyGoal: targetMin, avatarIdx: 0);
                Navigator.pop(ctx);
